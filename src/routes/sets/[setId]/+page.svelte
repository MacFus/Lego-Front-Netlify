	...
	{#if $isLoggedIn}
		<div class="yellow-container">
			<div class="header-container">
				<div class="header">
					<p>LEGO SET {parts.sets[0].name}</p>
				</div>
				<div class="breadcrumb">
					<p>
						LEGO Sets &gt; {parts.sets[0].themeName} &gt; {parts.sets[0].year} &gt; {parts.sets[0]
							.setNum}
					</p>
				</div>
			</div>
		...
		<div class="content">
			<div class="left-container">
				<div class="img-container">
					<img src={parts.sets[0].imgUrl} alt="NO IMG FOUND" />
				</div>
				<div class="details-container">
					{#if $hasEmbedded}
						<div class="section-header"><h4>Sets</h4></div>
						<div class="section-text">
							<p>There are <span>{parts.sets.length - 1}</span> unique sets in this inventory.</p>
						</div>
						<div class="tiles-container">
							{#each embeddedSets as set}
								<div class="tile">
									<Tile
										img={set.imgUrl}
					...
					{:else}
						<details>
							...
							<div class="tiles-container">
								{#each processed.requiredParts as part}
									<div class="tile">
